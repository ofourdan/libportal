      ...
      if (session == NULL)
        {
          ...
          session->signal_ids[SIGNAL_ZONES_CHANGED] = g_dbus_connection_signal_subscribe (bus,
                                                                                          PORTAL_BUS_NAME,
                                                                                          ...
                                                                                          session,
                                                                                          NULL);
          session->signal_ids[SIGNAL_ACTIVATED] = g_dbus_connection_signal_subscribe (bus,
                                                                                      PORTAL_BUS_NAME,
                                                                                      "org.freedesktop.portal.InputCapture",
                                                                                      "Activated",
                                                                                      PORTAL_OBJECT_PATH,
                                                                                      ...
                                                                                      session,
                                                                                      NULL);
          session->signal_ids[SIGNAL_DEACTIVATED] = g_dbus_connection_signal_subscribe (bus,
                                                                                        PORTAL_BUS_NAME,
                                                                                        "org.freedesktop.portal.InputCapture",
                                                                                        "Deactivated",
                                                                                        PORTAL_OBJECT_PATH,
                                                                                        ...
                                                                                        session,
                                                                                        NULL);
          session->signal_ids[SIGNAL_DISABLED] = g_dbus_connection_signal_subscribe (bus,
                                                                                     PORTAL_BUS_NAME,
                                                                                     "org.freedesktop.portal.InputCapture",
                                                                                     "Disabled",
                                                                                     PORTAL_OBJECT_PATH,
 ...
 * @session: a [class@InputCaptureSession]
 *
 * Connect this session to an EIS implementation.
 *
...
xdp_input_capture_session_connect_to_eis (XdpInputCaptureSession *session)
{
  ...
  g_return_val_if_fail (_xdp_input_capture_session_is_valid (session), -EINVAL);
...
convert_barrier (gpointer data, gpointer user_data)
{
  ...
  g_variant_builder_add (&dict, "{sv}", "barrier_id", g_variant_new_int32 (id));
 ...
 * [method@InputCaptureSession.input_capture_set_pointer_barriers_finish] to
 ...
 * the [signal@InputCapturePointerBarrier::active] property is changed on
                                                ...
                                                gpointer                        data)
{
  ...
  g_list_foreach (barriers, (GFunc)g_object_ref, NULL);
