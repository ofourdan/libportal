...
static void
xdp_input_capture_zone_finalize (GObject *object)
{
  G_OBJECT_CLASS (xdp_input_capture_zone_parent_class)->finalize (object);
}
...
xdp_input_capture_zone_class_init (XdpInputCaptureZoneClass *klass)
{
  ...
  object_class->finalize = xdp_input_capture_zone_finalize;
