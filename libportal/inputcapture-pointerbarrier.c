...
static void
xdp_input_capture_pointer_barrier_finalize (GObject *object)
{
  G_OBJECT_CLASS (xdp_input_capture_pointer_barrier_parent_class)->finalize (object);
}
...
xdp_input_capture_pointer_barrier_class_init (XdpInputCapturePointerBarrierClass *klass)
{
  ...
  object_class->finalize = xdp_input_capture_pointer_barrier_finalize;
